...
var run = function (data) {
    ...
    return 'function(){return {render:function(map) {var p=[],v =[];for(var i in map) {p.push(i);v.push(map[i]);}return (new Function(p, \"var _s=[];_s.push(' + source + ' return _s;\")).apply(null, v).join("");}};}';
